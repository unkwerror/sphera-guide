...
const FAQ_ITEMS = [
  {
    ...
    a: 'Скорее всего, не выдан доступ. Не жди неделю: напиши руководителю или Ивану сразу, это решается быстро.',
  },
  {
    q: 'Какую задачу создать первой?',
    a: 'Самую ближайшую и конкретную. Не «сделать весь проект», а шаг, который реально закрыть за 1-2 дня.',
  },
  {
    q: 'Чем бэклог отличается от канбана?',
    a: 'Бэклог - это очередь задач до старта. Канбан - это текущий поток по статусам. Бэклог планирует, канбан синхронизирует.',
  },
  {
    q: 'Куда писать блокер?',
    a: 'В комментарий к задаче в Сфере. Чат можно продублировать, но источник правды должен быть в карточке.',
  },
  {
    q: 'Когда списывать время?',
    a: 'В тот же день, когда работал. Даже 30 минут. Раз в неделю по памяти - это уже не данные, а гадание.',
  },
];
      ...
      <section id="contact" ref={containerRef} className="ct">
        <div className="ds-section">
          ...
          <p className="ct-intro">
            ...
            Не копи проблему до дедлайна: чем раньше пишешь, тем быстрее и спокойнее всё решается.
          </p>
                ...
                <div className="ct-contact-inner">
                  <div className="ct-contact-left">
                    ...
                    <div className="ct-contact-info">
                      ...
                      <span className="ct-contact-role">Поддержка по работе в Сфере · Мехатроника и робототехника</span>
                    </div>
                  </div>
          ...
          <div data-reveal className="ct-cta motion-panel">
            ...
            <div className="ct-cta-inner">
              <p className="ct-cta-text">
                Нужна помощь - напиши. Готов стартовать - открой Сферу и создай первую рабочую карточку.
              </p>
              <a
                href="https://saas.sferaplatform.ru/products/tasks"
